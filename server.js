...
//       if (arr[a].type == "folder") {
//         if (arr[a]._id == _id) {
//           rimraf(arr[a].folderPath, function (error) {
//             if (error) {
//               console.error("Error removing folder:", error);
//             } else {
//               console.log("Folder removed:", arr[a].folderPath);
//             }
//           });
//           arr.splice(a, 1);
//           break;
...
//     return arr;
//   }
// async function removeFolderReturnUpdated(arr, _id) {
//     for (var a = 0; a < arr.length; a++) {
//       if (arr[a].type === "folder") {
//         if (arr[a]._id.toString() === _id) {
//           const folderPath = arr[a].folderPath;
...
//         if (arr[a].files.length > 0) {
//           arr[a]._id = ObjectId(arr[a]._id);
//           await removeFolderReturnUpdated(arr[a].files, _id);
//         }
//       }
//     }
//     return arr;
